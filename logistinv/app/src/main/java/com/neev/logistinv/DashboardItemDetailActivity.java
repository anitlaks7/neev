 ...
 * in a {@link DashboardItemListActivity}.
 * <p/>
...
public class DashboardItemDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(DashboardItemDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(DashboardItemDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, DashboardItemListActivity.class));
            return true;
        }
